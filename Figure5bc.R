setwd("/data1/home/liu3zhen/lr42/traits")

td <- read.delim("/data1/home/liu3zhen/lr42/traits/data_from_Juliana.txt", stringsAsFactors = F) # trait data
...
# plot
pdf("lr42.leafrust.CIMMYT.traits.pdf", width = 4, height = 6)
par(mar = c(3, 4, 4, 1), mfrow = c(2, 1))
bararrow(dataf = seedling.plotdf, plotcols = 1:2, pmain = "Seedling Leaf Rust", pxlab = "", pylab = "Disease severity",
         plab.cex = 1.1, pmain.cex = 1,
         barcolors = c("dark green", "blue"), barnames = c("Lr42+", "Lr42-"), barnames.cex = 1, barnames.las = 1,
